...
Finally, I committed my changes and save the data package as a zip file. This zip file contains both the original CSV file and the metadata as a JSON data package file, neatly bundled together.
