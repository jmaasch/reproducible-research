...
Here is a preview of the dataset that I was working with.
...
First, I invoked the `infer()` method to autopopulate the majority of the fields in my JSON data package.
